        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <h3 class="text-lg font-semibold text-gray-800 dark:text-gray-200 mb-4">Form Edit Aset</h3>
                    ...
                    <form action="{{ route('aset.update', $aset) }}" method="POST">
                        ...
                        <div class="mb-4">
                            <label for="name"
                                ...
                                Aset</label>
                            <input type="text" name="name" id="name" value="{{ old('name', $aset->name) }}"
                        ...
                        <div class="mb-4">
                            ...
                            <select name="category_id" id="category_id"
                                ...
                                <option value="{{ $category->id }}"
                                    {{ $category->id == $aset->category_id ? 'selected' : '' }}>
                                    {{ $category->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="location_id" id="location_id"
                                ...
                                <option value="{{ $location->id }}"
                                    {{ $location->id == $aset->location_id ? 'selected' : '' }}>
                                    {{ $location->name }}
                                </option>
                                @endforeach
                            </select>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                            <div>
                                ...
                                <input type="date" name="purchase_date" id="purchase_date"
                                    value="{{ old('purchase_date', $aset->purchase_date) }}"
                                    class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                            <div>
                                ...
                                <input type="number" name="purchase_price" id="purchase_price"
                                    value="{{ old('purchase_price', $aset->purchase_price) }}"
                                    class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500">
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="status" id="status"
                                class="mt-1 block w-full rounded-md shadow-sm border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-indigo-500 focus:border-indigo-500">
                                <option value="Tersedia" {{ $aset->status == 'Tersedia' ? 'selected' : '' }}>Tersedia
                                </option>
                                <option value="Dipinjam" {{ $aset->status == 'Dipinjam' ? 'selected' : '' }}>Dipinjam
                                </option>
                                <option value="Rusak" {{ $aset->status == 'Rusak' ? 'selected' : '' }}>Rusak</option>
                                <option value="Dalam Perbaikan"
                                    {{ $aset->status == 'Dalam Perbaikan' ? 'selected' : '' }}>Dalam Perbaikan</option>
                            </select>
                        </div>
