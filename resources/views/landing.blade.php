...
<body class="antialiased bg-gray-950 text-white font-inter">
    {{-- Menggunakan warna latar belakang yang sangat gelap --}}
    <div class="relative min-h-screen flex flex-col">
        ...
        <nav class="relative z-10 w-full p-6 flex justify-end items-center">
            <div class="space-x-4">
                <a href="{{ route('login') }}"
                    class="btn-minimal btn-primary-minimal inline-block bg-blue-600 text-white font-medium py-2 px-6 rounded-lg text-sm shadow-md">
                    <i class="fas fa-sign-in-alt mr-1"></i> Login
                </a>
                <a href="{{ route('register') }}"
                    class="btn-minimal btn-secondary-minimal inline-block bg-transparent border border-gray-600 text-gray-300 font-medium py-2 px-6 rounded-lg text-sm shadow-md">
            ...
            <div class="text-center max-w-2xl mx-auto"> {{-- Menghilangkan card transparan untuk kesan lebih bersih --}}
                ...
                <div class="fade-in-up" style="animation-delay: 0.2s;">
                    ...
                    <img src="{{ asset('images/logo-pelindo.png') }}" alt="Logo Pelindo"
                        class="w-auto h-28 md:h-32 mx-auto mb-10 opacity-90">
                </div>

                {{-- Judul dengan animasi --}}
                <div class="fade-in-up" style="animation-delay: 0.4s;">
                    <h1
                        class="text-5xl sm:text-6xl md:text-7xl font-extrabold mb-4 tracking-tight text-white leading-tight">
                        Sistem Manajemen Aset Pelindo
                    </h1>
                </div>
